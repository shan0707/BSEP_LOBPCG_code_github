function [RX, RY, ZX, ZY, Theta_pos, Res, lock_ID, time_mat] = LOBPCG_CIHL(Omega, X0, Y0, T, par)
...
for i = 1 : Max_iter
    ...
    %% Project
    [Theta, VX, VY, time_mat] = RayleighRitz_C(UX, UY, OmegaZX, OmegaZY, A, B,...
                                    conj_A, conj_B, k_pos, np, time_mat, 'all');
